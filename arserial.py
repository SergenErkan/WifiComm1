...
class ArSerial(serial.Serial):
    ...
    def __init__(self, baudrate = 9600, bytesize = 8, parity = 'N', stopbits = 1, timeout = 0.2, port='COM9', *args, **kwargs):
        print("Initialized")
        # self.port(baudrate = baudrate, bytesize = bytesize, parity = parity, stopbits = stopbits, timeout = timeout, port=port, *args, **kwargs)
